    ...
    <S.Container>
      <S.BlockGrid>
        ...
        <S.Action className="block__action">
          <p>
            Whether on Infinite World or through custom solutions, we can help
        ...
        <S.ImgBlock className="block__img">
          ...
          <img width="192" height="540" src={shootImg} className="img__shoot" />
          <img width="341" height="280" src={shoesImg} className="img__shoes" />
        </S.ImgBlock>
      </S.BlockGrid>
    </S.Container>
  );
