...
export const Gradient1 = styled.div`    
    ...
    top:16%;
    left:23%;
    background: radial-gradient(50% 50% at 50% 50%, rgba(221, 248, 116, 0.18) 0%, rgba(221, 248, 116, 0) 100%);
...
export const Gradient2 = styled.div`
    background: radial-gradient(50% 50% at 50% 50%, rgba(116, 248, 185, 0.12) 0%, rgba(116, 248, 185, 0) 100%);
    position:absolute;
    max-width:100%;
    z-index:2;
    height:57rem;
...
export const Gradient3 = styled.div`
    background: radial-gradient(50% 50% at 50% 50%, rgba(109, 40, 255, 0.06) 0%, rgba(109, 40, 255, 0) 100%);
    position:absolute;
    max-width:100%;
    height:23rem;
    z-index:2;
